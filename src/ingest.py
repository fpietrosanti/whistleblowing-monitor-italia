...
REGIONE_MAP = {
    ...
    "04": "Trentino-Alto Adige", "05": "Veneto",
    "06": "Friuli Venezia Giulia", "07": "Liguria",
    "08": "Emilia-Romagna", "09": "Toscana", "10": "Umbria",
    "11": "Marche", "12": "Lazio", "13": "Abruzzo", "14": "Molise",
    "15": "Campania", "16": "Puglia", "17": "Basilicata",
        ...
        for r in raw_records:
            ...
            db.execute("""
                INSERT INTO pa (cod_amm, denominazione, sito_web, categoria,
                                regione, provincia, comune, tipologia, cf, updated_at)
